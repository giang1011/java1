...
public class Bt2 {
    public static void main(String[] args) {
        ...
        System.out.printf("Amount: %.0f VND, Term: %s, Deposit Type: VND, Interest for the term: %.0f VND, Principal + Interest: %.0f VND\n",
                principal, termDisplay, interest, totalAmount);
